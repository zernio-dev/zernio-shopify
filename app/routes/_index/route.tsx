    ...
    <main className={styles.page}>
      ...
      <section className={styles.statement}>
        <h1 className={styles.headline}>
          <span className={styles.lineSell}>
            <span>Sell on</span>
            <span className={styles.inlineShopifyWrap}>
              <svg
          ...
          <span className={styles.lineShout}>
            <span className={styles.shoutWord}>Shout</span>{" "}
            <span className={styles.shoutTail}>everywhere else.</span>
          </span>
        </h1>
